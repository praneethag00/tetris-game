/*
 * ZeeBrick is a subclass that inherits TetrisBrick class and
...
public class ZeeBrick extends TetrisBrick {
    public ZeeBrick() {
        super(new int[][] {{0,4}, {0,5}, {1,5}, {1,6}}, Color.cyan);
        initPosition();
    }
    ...
    public int[][] generatePosition(int orientation) {
        ...
        for (int row = 0; row < pos.length; row++) {
            ...
            switch (orientation) {
                case 0:
                    return new int[][]{{0, 4}, {0, 5}, {1, 5}, {1, 6}};
                case 1:
                    return new int[][]{{0, 6}, {1, 5}, {1, 6}, {2, 5}};
            }
        }
            return new int[][]{{0, 4}, {0, 5}, {1, 5}, {1, 6}};
        }
