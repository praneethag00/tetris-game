/*
 * JayBrick is a subclass that inherits TetrisBrick class and
...
public class JayBrick extends TetrisBrick {
    public JayBrick() {
        super(new int[][] {{0,4}, {0,5}, {0,6}, {1,6}}, Color.green);
        initPosition();
    }
    ...
    public int[][] generatePosition(int orientation)
    {
        switch (orientation) {
            case 0:
                return new int[][] {{0,4}, {0,5}, {0,6}, {1,6}};
            case 1:
                return new int[][] {{0,6}, {1,6}, {2,5}, {2,6}};
            case 2:
                return new int[][] {{0,5}, {1,5}, {1,6}, {1,7}};
            case 3:
                return new int[][] {{0,5}, {0,6}, {1,5}, {1,6}};
        }
        return new int[][] {{0,4}, {0,5}, {0,6}, {1,6}};
    }
